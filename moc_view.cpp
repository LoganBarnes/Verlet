...
QT_MOC_LITERAL(1, 5, 11), // "changeTitle"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 4) // "tick"

    },
    "View\0changeTitle\0\0tick"
};
...
void View::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->changeTitle((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&View::changeTitle)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void View::changeTitle(const QString _t1)
{
